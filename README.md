# Spotipi & Wheather
### Overview
This project is to display spotify cover art on 32x32 or 64x64 led matrix from the Spotify web api.
...
* Enter your location data and api-key in the field ```query``` in ```displayCoverArt.py```.
